...
export const metadata: Metadata = { title: "Message Center" };
...
export default async function MessageCenterPage() {
  ...
  return <StaffPortal initialSession={bootstrap} fixtureMode={fixtureMode} fixtureScenarios={fixtureScenarios} fixturePersonas={fixturePersonas} initialPage="message-center" />;
}
